...
export default function SponsorshipManagement() {
  return (
    <>
      <Helmet>
        <title>Sponsorship Management - EventSync Admin</title>
      </Helmet>
          ...
          <div className="row">
            <div className="col-lg-12">
              ...
              <p style={{
                ...
                Manage sponsorship tiers, sponsors, and revenue analytics
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div style={{
            ...
            <p style={{color: '#6b7280', fontSize: '16px', marginBottom: '30px', lineHeight: '1.6'}}>
              Comprehensive sponsorship management system with tier-based packages, sponsor tracking, and revenue analytics.
            </p>
            <div style={{
              display: 'grid',
              ...
              <div style={{
                ...
                <p style={{color: '#6b7280', fontSize: '14px'}}>
                  Gold, Silver, and Bronze tier management
                </p>
              </div>
              <div style={{
                background: '#f8fafc',
                ...
                <p style={{color: '#6b7280', fontSize: '14px'}}>
                  Manage sponsor contacts and partnerships
                </p>
              </div>
              <div style={{
                background: '#f8fafc',
                ...
                <p style={{color: '#6b7280', fontSize: '14px'}}>
                  Track sponsorship revenue and performance
                </p>
              </div>
            </div>
          </div>
