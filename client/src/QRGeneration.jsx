          ...
          <div className="row">
            <div className="col-lg-12">
              ...
              <p style={{
                ...
                Generate and manage QR codes for event check-ins and registrations
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div style={{
            ...
            <p style={{color: '#6b7280', fontSize: '16px', marginBottom: '30px', lineHeight: '1.6'}}>
              This module will allow administrators to generate QR codes for events, manage QR templates, and track QR usage analytics.
            </p>
            <div style={{
              display: 'grid',
              ...
              <div style={{
                ...
                <p style={{color: '#6b7280', fontSize: '14px'}}>
                  Generate unique QR codes for each event registration
                </p>
              </div>
              <div style={{
                background: '#f8fafc',
                ...
                <p style={{color: '#6b7280', fontSize: '14px'}}>
                  Track QR usage, scan rates, and check-in analytics
                </p>
              </div>
              <div style={{
                background: '#f8fafc',
                ...
                <p style={{color: '#6b7280', fontSize: '14px'}}>
                  Customize QR code designs and branding options
                </p>
              </div>
            </div>
          </div>
