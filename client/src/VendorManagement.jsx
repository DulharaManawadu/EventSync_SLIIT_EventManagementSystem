...
export default function VendorManagement() {
  return (
    <>
      <Helmet>
        <title>Vendor Management - EventSync Admin</title>
      </Helmet>
        ...
        <div className="container">
          <div style={{
            ...
            <p style={{color: '#6b7280', fontSize: '16px', marginBottom: '30px', lineHeight: '1.6'}}>
              Complete vendor management system for tracking service providers, contracts, and vendor performance analytics.
            </p>
            <div style={{
              display: 'grid',
              ...
              <div style={{
                ...
                <p style={{color: '#6b7280', fontSize: '14px'}}>
                  Comprehensive vendor database and contacts
                </p>
              </div>
              <div style={{
                background: '#f8fafc',
                ...
                <p style={{color: '#6b7280', fontSize: '14px'}}>
                  Track vendor contracts and agreements
                </p>
              </div>
              <div style={{
                background: '#f8fafc',
